import{l as b,t as v,B as g,r as h,x as d}from"./index-a3470178.js";import{n as r,c as w}from"./if-defined-122c0166.js";import"./index-0aaaa7d9.js";const p=b`
  button {
    border: none;
...
`;var i=globalThis&&globalThis.__decorate||function(n,t,e,s){var c=arguments.length,o=c<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,e):s,u;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,e,s);else for(var l=n.length-1;l>=0;l--)(u=n[l])&&(o=(c<3?u(o):c>3?u(t,e,o):u(t,e))||o);return c>3&&o&&Object.defineProperty(t,e,o),o};let a=class extends h{constructor(){super(...arguments),this.variant="accent",this.imageSrc="",this.disabled=!1,this.icon="externalLink",this.size="md",this.text=""}render(){const t=this.size==="sm"?"small-600":"paragraph-600";return d`
      <button
