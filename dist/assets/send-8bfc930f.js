import{l as f,r as w,v as z,G as H,K as a,x as u,t as W,B as V,m as b,q as L,N,J as F,F as D,L as G}from"./index-a3470178.js";import{n as d,r as c,c as g,U as v,o as q}from"./if-defined-122c0166.js";import{e as U,n as O}from"./index-fa796e28.js";import"./index-21ede41c.js";import"./index-64e916b6.js";import"./index-2e31ebee.js";import"./index-97f27cbe.js";import"./index-35220e00.js";import"./index-0aaaa7d9.js";import"./index-481f0bfe.js";const M=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var E=globalThis&&globalThis.__decorate||function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let T=class extends w{constructor(){super(...arguments),this.inputElementRef=U(),this.instructionElementRef=U(),this.instructionHidden=!!this.value,this.pasting=!1,this.onDebouncedSearch=z.debounce(async e=>{const i=await H.getEnsAddress(e);if(a.setLoading(!1),i){a.setReceiverProfileName(e),a.setReceiverAddress(i);const n=await H.getEnsAvatar(e);a.setReceiverProfileImageUrl(n||void 0)}else a.setReceiverAddress(e),a.setReceiverProfileName(void 0),a.setReceiverProfileImageUrl(void 0)})}firstUpdated(){this.value&&(this.instructionHidden=!0),this.checkHidden()}render(){return u` <wui-flex
...
`;var j=globalThis&&globalThis.__decorate||function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let P=class extends w{constructor(){super(...arguments),this.inputElementRef=U(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
      ${O(this.inputElementRef)}
      type="text"
      inputmode="decimal"
      pattern="[0-9,.]*"
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else Y.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(K,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};P.styles=[W,V,J];j([d({type:Boolean})],P.prototype,"disabled",void 0);j([d({type:String})],P.prototype,"value",void 0);j([d({type:String})],P.prototype,"placeholder",void 0);P=j([g("wui-input-amount")],P);const Q=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
...
`;var A=globalThis&&globalThis.__decorate||function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let k=class extends w{render(){return u` <wui-flex
    ...
    >`}handleSelectButtonClick(){b.push("WalletSendSelectToken")}sendValueTemplate(){if(this.token&&this.sendTokenAmount){const i=this.token.price*this.sendTokenAmount;return u`<wui-text class="totalValue" variant="small-400" color="fg-200"
      ...
      >`}return null}maxAmountTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u` <wui-text variant="small-400" color="error-100">
        ...
        ${v.roundNumber(Number(this.token.quantity.numeric),6,5)}
      </wui-text>`:null}actionTemplate(){return this.token?this.sendTokenAmount&&this.sendTokenAmount>Number(this.token.quantity.numeric)?u`<wui-link @click=${this.onBuyClick.bind(this)}>Buy</wui-link>`:u`<wui-link @click=${this.onMaxClick.bind(this)}>Max</wui-link>`:null}onInputChange(e){a.setTokenAmount(e.detail)}onMaxClick(){if(this.token&&typeof this.gasPrice<"u"){const e=this.token.address===void 0||Object.values(L.NATIVE_TOKEN_ADDRESS).some(r=>{var t;return((t=this.token)==null?void 0:t.address)===r}),i=N.bigNumber(this.gasPrice).div(N.bigNumber(10).pow(Number(this.token.quantity.decimals))),n=e?N.bigNumber(this.token.quantity.numeric).minus(i):N.bigNumber(this.token.quantity.numeric);a.setTokenAmount(Number(n.toFixed(20)))}}onBuyClick(){b.push("OnRampProviders")}};k.styles=Q;A([d({type:Object})],k.prototype,"token",void 0);A([d({type:Number})],k.prototype,"sendTokenAmount",void 0);A([d({type:Number})],k.prototype,"gasPriceInUSD",void 0);A([d({type:Number})],k.prototype,"gasPrice",void 0);k=A([g("w3m-input-token")],k);const X=f`
  :host {
    display: block;
  }
...
`;var R=globalThis&&globalThis.__decorate||function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let $=class extends w{constructor(){super(...arguments),this.text="",this.address="",this.isAddress=!1}render(){return u`<wui-text variant="large-500" color="fg-100">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.isAddress?u`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?u`<wui-image src=${this.imageSrc}></wui-image>`:u`<wui-icon size="inherit" color="fg-200" name="networkPlaceholder"></wui-icon>`}};$.styles=[W,V,ee];R([d()],$.prototype,"text",void 0);R([d()],$.prototype,"address",void 0);R([d()],$.prototype,"imageSrc",void 0);R([d({type:Boolean})],$.prototype,"isAddress",void 0);$=R([g("wui-preview-item")],$);const te=f`
  :host {
    display: flex;
...
`;var _=globalThis&&globalThis.__decorate||function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let S=class extends w{render(){return u` <wui-text variant="small-400" color="fg-200">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(e){e&&b.push("Networks",{network:e})}};S.styles=ie;_([d()],S.prototype,"receiverAddress",void 0);_([d({type:Object})],S.prototype,"caipNetwork",void 0);_([d({type:Number})],S.prototype,"networkFee",void 0);S=_([g("w3m-wallet-send-details")],S);const ne=f`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
