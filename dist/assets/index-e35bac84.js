import{Q as d,V as m,X as w,l as f,r as v,x as b}from"./index-a3470178.js";import{r as u,c as h}from"./if-defined-122c0166.js";const e=d({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return m(e,()=>o(e))},subscribeKey(o,t){return w(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=f`
  :host {
    pointer-events: none;
  }
