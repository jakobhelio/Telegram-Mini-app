import{l as A,r as U,F as _,J as i,N as D,x as u,q as V,y as W,m as $,v as M,M as K,A as B,W as F,t as Q,B as q}from"./index-a3470178.js";import{r as s,n as g,c as C,U as f}from"./if-defined-122c0166.js";import"./index-fa796e28.js";import{M as R}from"./index-1753a888.js";import"./index-e35bac84.js";import"./index-80b43f45.js";import"./index-2e31ebee.js";import"./index-97f27cbe.js";import"./index-0aaaa7d9.js";import"./index-481f0bfe.js";import"./index-21ede41c.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",L=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&L&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!L&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
...
`;var b=globalThis&&globalThis.__decorate||function(l,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,n);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};const J=V.CONVERT_SLIPPAGE_TOLERANCE;let x=class extends U{constructor(){var t;super(),this.unsubscribe=[],this.networkName=(t=_.state.activeCaipNetwork)==null?void 0:t.name,this.detailsOpen=!1,this.sourceToken=i.state.sourceToken,this.toToken=i.state.toToken,this.toTokenAmount=i.state.toTokenAmount,this.sourceTokenPriceInUSD=i.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=i.state.toTokenPriceInUSD,this.gasPriceInUSD=i.state.gasPriceInUSD,this.priceImpact=i.state.priceImpact,this.maxSlippage=i.state.maxSlippage,this.networkTokenSymbol=i.state.networkTokenSymbol,this.inputError=i.state.inputError,this.unsubscribe.push(i.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.gasPriceInUSD=e.gasPriceInUSD,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?D.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const e=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};x.styles=[H];b([s()],x.prototype,"networkName",void 0);b([g()],x.prototype,"detailsOpen",void 0);b([s()],x.prototype,"sourceToken",void 0);b([s()],x.prototype,"toToken",void 0);b([s()],x.prototype,"toTokenAmount",void 0);b([s()],x.prototype,"sourceTokenPriceInUSD",void 0);b([s()],x.prototype,"toTokenPriceInUSD",void 0);b([s()],x.prototype,"gasPriceInUSD",void 0);b([s()],x.prototype,"priceImpact",void 0);b([s()],x.prototype,"maxSlippage",void 0);b([s()],x.prototype,"networkTokenSymbol",void 0);b([s()],x.prototype,"inputError",void 0);x=b([C("w3m-swap-details")],x);const X=A`
  :host {
    width: 100%;
  }
...
`;var z=globalThis&&globalThis.__decorate||function(l,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,n);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let N=class extends U{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};N.styles=[X];z([g()],N.prototype,"target",void 0);N=z([C("w3m-swap-input-skeleton")],N);const Y=A`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var T=globalThis&&globalThis.__decorate||function(l,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,n);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};const Z=5e-5;let m=class extends U{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",e=D.bigNumber(t).gt("0");return u`
    ...
    `:u` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){const t=D.multiply(this.balance,this.price),e=t?t==null?void 0:t.gt(Z):!1;return u`
    ...
    </button>`}onFocusChange(t){this.focused=t}onSelectToken(){W.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),$.push("SwapSelectToken",{target:this.target})}onBuyToken(){$.push("OnRampProviders")}};m.styles=[Y];T([g()],m.prototype,"focused",void 0);T([g()],m.prototype,"balance",void 0);T([g()],m.prototype,"value",void 0);T([g()],m.prototype,"price",void 0);T([g()],m.prototype,"marketValue",void 0);T([g()],m.prototype,"disabled",void 0);T([g()],m.prototype,"target",void 0);T([g()],m.prototype,"token",void 0);T([g()],m.prototype,"onSetAmount",void 0);T([g()],m.prototype,"onSetMaxValue",void 0);m=T([C("w3m-swap-input")],m);const tt=A`
...
`;var w=globalThis&&globalThis.__decorate||function(l,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,n);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let d=class extends U{constructor(){var t;super(),this.unsubscribe=[],this.detailsOpen=!1,this.caipNetworkId=(t=_.state.activeCaipNetwork)==null?void 0:t.caipNetworkId,this.initialized=i.state.initialized,this.loadingQuote=i.state.loadingQuote,this.loadingPrices=i.state.loadingPrices,this.loadingTransaction=i.state.loadingTransaction,this.sourceToken=i.state.sourceToken,this.sourceTokenAmount=i.state.sourceTokenAmount,this.sourceTokenPriceInUSD=i.state.sourceTokenPriceInUSD,this.toToken=i.state.toToken,this.toTokenAmount=i.state.toTokenAmount,this.toTokenPriceInUSD=i.state.toTokenPriceInUSD,this.inputError=i.state.inputError,this.gasPriceInUSD=i.state.gasPriceInUSD,this.fetchError=i.state.fetchError,this.onDebouncedGetSwapCalldata=M.debounce(async()=>{await i.swapTokens()},200),_.subscribeKey("activeCaipNetwork",e=>{this.caipNetworkId!==(e==null?void 0:e.caipNetworkId)&&(this.caipNetworkId=e==null?void 0:e.caipNetworkId,i.resetState(),i.initializeState())}),this.unsubscribe.push(K.subscribeKey("open",e=>{e||i.resetState()}),$.subscribeKey("view",e=>{e.includes("Swap")||i.resetValues()}),i.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.gasPriceInUSD=e.gasPriceInUSD,this.fetchError=e.fetchError}))}firstUpdated(){i.initializeState(),this.watchTokensAndValues()}disconnectedCallback(){this.unsubscribe.forEach(t=>t==null?void 0:t()),clearInterval(this.interval)}render(){return u`
    ...
    </wui-flex>`}onSwitchTokens(){i.switchTokens()}onSwapPreview(){var t,e;if(this.fetchError){i.swapTokens();return}W.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:((t=this.sourceToken)==null?void 0:t.symbol)||"",swapToToken:((e=this.toToken)==null?void 0:e.symbol)||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:B.state.preferredAccountType===F.ACCOUNT_TYPES.SMART_ACCOUNT}}),$.push("SwapPreview")}};d.styles=tt;w([s()],d.prototype,"interval",void 0);w([s()],d.prototype,"detailsOpen",void 0);w([s()],d.prototype,"caipNetworkId",void 0);w([s()],d.prototype,"initialized",void 0);w([s()],d.prototype,"loadingQuote",void 0);w([s()],d.prototype,"loadingPrices",void 0);w([s()],d.prototype,"loadingTransaction",void 0);w([s()],d.prototype,"sourceToken",void 0);w([s()],d.prototype,"sourceTokenAmount",void 0);w([s()],d.prototype,"sourceTokenPriceInUSD",void 0);w([s()],d.prototype,"toToken",void 0);w([s()],d.prototype,"toTokenAmount",void 0);w([s()],d.prototype,"toTokenPriceInUSD",void 0);w([s()],d.prototype,"inputError",void 0);w([s()],d.prototype,"gasPriceInUSD",void 0);w([s()],d.prototype,"fetchError",void 0);d=w([C("w3m-swap-view")],d);const et=A`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var P=globalThis&&globalThis.__decorate||function(l,t,e,n){var r=arguments.length,o=r<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,e):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,n);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};let S=class extends U{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var e;if(!this.visible)return null;const t=this.amount&&this.price?(e=D.multiply(this.price,this.amount))==null?void 0:e.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};S.styles=[Q,q,ot];P([g()],S.prototype,"imageSrc",void 0);P([g()],S.prototype,"name",void 0);P([g()],S.prototype,"symbol",void 0);P([g()],S.prototype,"price",void 0);P([g()],S.prototype,"amount",void 0);P([s()],S.prototype,"visible",void 0);P([s()],S.prototype,"imageError",void 0);S=P([C("wui-token-list-item")],S);const it=A`
  :host {
