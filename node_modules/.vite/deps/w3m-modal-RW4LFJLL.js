...
var W3mModal = class W3mModal2 extends LitElement {
  ...
  onNewNetwork(nextCaipNetwork) {
    ...
    const shouldGoBack = !isConnectingExternal && (isNotConnected || isUnsupportedNetworkScreen || isNetworkChangedInSameNamespace);
    if (shouldGoBack) {
      RouterController.goBack();
    }
...
//# sourceMappingURL=w3m-modal-RW4LFJLL.js.map
