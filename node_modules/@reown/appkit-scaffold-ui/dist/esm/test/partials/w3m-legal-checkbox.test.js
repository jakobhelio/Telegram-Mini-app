...
describe('W3mLegalCheckbox', () => {
    ...
    it('it should return checkbox if legalCheckbox is true', async () => {
        const element = await fixture(html `<w3m-legal-checkbox></w3m-legal-checkbox>`);
        const checkbox = HelpersUtil.querySelect(element, CHECKBOX_TEST_ID);
        expect(checkbox).toBeDefined();
        expect(HelpersUtil.getTextContent(checkbox)).toBe('I agree to our terms of service and privacy policy');
    });
...
//# sourceMappingURL=w3m-legal-checkbox.test.js.map