...
import { AssetController, ModalController, OnRampController, OptionsController } from '@reown/appkit-controllers';
...
describe('W3mOnrampFiatSelectView', () => {
    beforeEach(() => {
        vi.spyOn(OnRampController, 'state', 'get').mockReturnValue({
            ...
            paymentCurrency: mockCurrencies[0],
    ...
    it('should render currency list', async () => {
        const element = await fixture(html `<w3m-onramp-fiat-select-view></w3m-onramp-fiat-select-view>`);
    ...
    it('should handle subscription updates', async () => {
        const element = await fixture(html `<w3m-onramp-fiat-select-view></w3m-onramp-fiat-select-view>`);
        await elementUpdated(element);
        const updatedCurrencies = [mockCurrencies[0]];
        const updatedState = {
            ...OnRampController.state,
        ...
        const updatedElement = await fixture(html `<w3m-onramp-fiat-select-view></w3m-onramp-fiat-select-view>`);
...
//# sourceMappingURL=w3m-onramp-fiat-select-view.test.js.map