import{i as h,a as u,c as g,r as m,x as w}from"./index-n_ZehpUP.js";import{y as f,G as v,H as b}from"./index-tLyCCnDv.js";const e=f({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),s={state:e,subscribe(o){return b(e,()=>o(e))},subscribeKey(o,t){return v(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},x=h`
  :host {
    pointer-events: none;
  }
